...
```text
SOFORT aus der Gruppe laufen
```

Explosion nach wenigen Sekunden.
...
Nicht angreifen wenn kontrolliert.
...
Chain Lightning sehr stark.

Add Wellen priorisieren.
